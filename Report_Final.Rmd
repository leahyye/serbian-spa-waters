...
```{r outlierTable, fig.cap="Water sources with at least one variable > 3 standard deviations from the mean",echo=FALSE}
...
```{r outliersPCAScores, echo = FALSE}
...
```{r confusionMatrix, fig.cap="", echo=FALSE}
