...
In contrast, pH shows moderate negative correlations with several ions (e.g., C$\mathrm{Ca^{2+}}$, $\mathrm{Mg^{2+}}$, $\mathrm{HCO_3^-}$), suggesting 
different geochemical influences. Overall, the matrix highlights both tightly linked chemical groups and variables with weaker or opposing trends.
...
```{r QQplotLogTransorm, echo=FALSE, warning=FALSE, message = FALSE}
